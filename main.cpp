...
void doTest2(){
    ...
    int *ptr = &numOfStudent;
    addStudent(students,ptr ,"Ana", 1051, 88, 65);
    addStudent(students,ptr ,"Suji", 1052, 90, 93);
    addStudent(students,ptr, "Zhang", 1053, 100, 40);
...
void doTest3(){
    ...
    int *ptr = &numOfStudent;
    deleteStudent(students, ptr, 1011);
    deleteStudent(students, ptr, 1029);
